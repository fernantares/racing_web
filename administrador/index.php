...
?>
        ...
        <div class="dashboard">
            <?php //-----------------FILA--------------------------- ?>
            <div class="section">
                <div onClick="pageSelected('autos/admin-autos');" class="dashboard-card">
                    <img src="../img/agregar_auto.png" alt="AGREGAR AUTO">
                    <div class="descr">ADMINISTRAR AUTOS</div>
                </div>
                <div onClick="pageSelected('fabricantes/frabricantes-admin');" class="dashboard-card">
                    <img src="../img/agregar_fabricante.png" alt="AGREGAR AUTO">
                    <div class="descr">ADMINISTRAR FABRICANTES</div>
                </div>
                <div onClick="pageSelected('auto-modelosmodel_admin');" class="dashboard-card">
